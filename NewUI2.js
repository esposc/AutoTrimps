...
//genBTC advanced settings - option buttons.
    ...
    createSetting('AutoAllocatePerks', ['Auto Allocate Perks', 'Faster Allocate Perks'], 'EXPERIMENTAL. Uses the AutoPerks ratio based preset system to automatically allocate your perks to spend whatever helium you have when you AutoPortal. ', 'multitoggle', 0, null, 'genBTC');
