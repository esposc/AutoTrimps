...
//AutoMaps + VoidMaps settings:
    ...
    createSetting('SpecModifier', 'Map Modifier', 'If you have enough fragments, always choose this modifier (if available) for generating maps', 'dropdown', 'Off', ['Off', 'Fast Attacks', 'Large Cache', 'Small Savoury Cache', 'Small Wooden Cache', 'Small Metal Cache', 'Prestigious', 'Huge Cache', 'Large Savoury Cache', 'Large Wooden Cache', 'Large Metal Cache'], 'Maps');
    createSetting('PoisonPres', 'Poison Prestige', 'When AutoMap farming, use your 5th poison nature zone to collect the next set of presitiges. First tries to use the highest extra zones affortable that contain prestiges, then tries to use Prestigious. Suggested to collect SpeedExplorers every 10 zones to always have the highest fragment gathering rate.', 'boolean', null, null, 'Maps');
