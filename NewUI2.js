...
//    createSetting('TryOnSpire', 'Try on Spire Level', 'Actually try to handle a Spire starting at level #. Applies to spire farming, squad breed timer, equipment, etc', 'value', '-1', null, 'Maps');
    ...
    createSetting('SpeedExplor', 'SpeedExplorer Rate', 'SpeedExplorers appear on every 10x zone maps. This setting controls how often to enter maps to obtain them. Rate is every value*10 zones. Disable with 0.', 'value', '0', null, 'Maps');
    createSetting('SpecModifier', 'Map Modifier', 'If you have enough fragments, always choose this modifier (if available) for generating maps', 'dropdown', 'Off', ['Off', 'Fast Attacks', 'Prestigious', 'Large Cache', 'Small Savoury Cache', 'Small Wooden Cache', 'Small Metal Cache', 'Huge Cache', 'Large Savoury Cache', 'Large Wooden Cache', 'Large Metal Cache'], 'Maps');
    createSetting('PoisonPres', 'Poison Prestige', 'When AutoMap farming, use your 5th poison nature zone to collect the next set of presitiges. First tries to use the highest extra zones affortable that contain prestiges, then tries to use Prestigious. Only starts initiating after Uni\'s "Force Prestige Z". Suggested to collect SpeedExplorers every 10 zones to always have the highest fragment gathering rate.', 'boolean', null, null, 'Maps');
...
//genBTC advanced settings - option buttons.
    ...
    createSetting('AutoAllocatePerks', ['Allocate Perks Off', 'Auto Allocate Perks', 'Faster Allocate Perks'], 'EXPERIMENTAL. Uses the AutoPerks ratio based preset system to automatically allocate your perks to spend whatever helium you have when you AutoPortal. ', 'multitoggle', 0, null, 'genBTC');
